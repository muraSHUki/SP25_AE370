...
snapshot_times = np.linspace(0, T - 3e-5, 18)
...
fig, axes = plt.subplots(6, 3, figsize=(6.5, 9))  # Full-page layout for 15 plots
...
# Remove any unused axes (if fewer than 15)
